            ...
            <div className="container-fluid bg-dark text-secondary mt-5 pt-5">
                <div className="row px-xl-5 pt-5">
                    <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                        ...
                        <p className="mb-2"><i className="fa fa-map-marker-alt text-primary mr-3"></i>123 Street, varanasi, India</p>
                        <p className="mb-2"><i className="fa fa-envelope text-primary mr-3"></i>info@example.com</p>
                        <p className="mb-0"><i className="fa fa-phone-alt text-primary mr-3"></i>+91 123567890</p>
                    </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4 mb-5">
                                ...
                                <div className="d-flex">
                                    <a className="btn btn-primary btn-square mr-2" href="https://twitter.com/sh1vamrai"><i className="fab fa-twitter"></i></a>
                                    <a className="btn btn-primary btn-square mr-2" href="https://github.com/shivamrai27"><i className="fab fa-github"></i></a>
                                    <a className="btn btn-primary btn-square mr-2" href="https://www.linkedin.com/in/shivam-rai-9ba102173/"><i className="fab fa-linkedin-in"></i></a>
                                    <a className="btn btn-primary btn-square" href="https://www.instagram.com/shivam.rai27/"><i className="fab fa-instagram"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row border-top mx-xl-5 py-4" style={{ borderColor: 'rgba(256, 256, 256, .1) !important' }}>
                    <div className="col-md-6 px-xl-0">
                        <p className="mb-md-0 text-center text-md-left text-secondary">
                            ...
                            by
                            <a className="text-primary" href=""> Shivam</a>
                        </p>
                    </div>
